...
import com.st.bmap.compose.MapStatusChangeStartedReason.Companion.fromInt
import com.st.bmap.compose.MapStatusChangeStartedReason.NO_MOVEMENT_YET
import com.st.bmap.compose.MapStatusChangeStartedReason.UNKNOWN
 ...
 */
@Immutable
public enum class MapStatusChangeStartedReason(public val value: Int) {
    UNKNOWN(-2),
    NO_MOVEMENT_YET(-1),
    GESTURE(OnMapStatusChangeListener.REASON_GESTURE),
    API_ANIMATION(OnMapStatusChangeListener.REASON_API_ANIMATION),
    DEVELOPER_ANIMATION(OnMapStatusChangeListener.REASON_DEVELOPER_ANIMATION);

    public companion object {
        /**
         * Converts from the Maps SDK [com.google.android.gms.maps.GoogleMap.OnCameraMoveStartedListener]
         * constants to [MapStatusChangeStartedReason], or returns [UNKNOWN] if there is no such
         * [MapStatusChangeStartedReason] for the given [value].
         *
         ...
         */
        public fun fromInt(value: Int): MapStatusChangeStartedReason {
